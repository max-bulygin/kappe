...
function kp_custom_settings()
{
  ...
  // Contact Form 7
  register_setting( 'kappe-settings-group', 'cf7_value_ru' );
  register_setting( 'kappe-settings-group', 'cf7_value_en' );
  add_settings_section( 'kappe-general-options', 'Contact Form Options', 'kp_contact_form_options', 'kappe_options' );
  add_settings_field( 'contact-form-textarea_ru', 'Contact Form 7 shortcode RU', 'kp_contact_form_input_ru', 'kappe_options', 'kappe-general-options' );
  add_settings_field( 'contact-form-textarea_en', 'Contact Form 7 shortcode EN', 'kp_contact_form_input_en', 'kappe_options', 'kappe-general-options' );
...
function kp_contact_form_options()
{
  echo '<p>Paste code generated by Contact Form 7 plugin. <strong>Put html_class="clearfix" attribute after title attribute</strong></p>';
}

function kp_contact_form_input_ru()
{
  $field_value = esc_attr(get_option( 'cf7_value_ru' ));
  echo '<input type="text" size="60" name="cf7_value_ru" value="' . $field_value . '">';
}

function kp_contact_form_input_en()
{
  $field_value = esc_attr(get_option( 'cf7_value_en' ));
  echo '<input type="text" size="60" name="cf7_value_en" value="' . $field_value . '">';
}
