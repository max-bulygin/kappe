...
function kp_custom_settings()
{
  ...
  // Contact Form 7
  register_setting( 'kappe-settings-group', 'cf7_value' );
  add_settings_section( 'kappe-general-options', 'Contact Form Options', 'kp_contact_form_options', 'kappe_options' );
  add_settings_field( 'contact-form-textarea', 'Contact Form 7 shortcode', 'kp_contact_form_input', 'kappe_options', 'kappe-general-options' );
...
function kp_contact_form_input()
{
  $field_value = esc_attr(get_option( 'cf7_value' ));
  echo '<input type="text" size="60" name="cf7_value" value="' . $field_value . '">';
}
